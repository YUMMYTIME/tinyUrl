var app = angular.module("tinyurlApp",["ngRoute","ngResource"]);//before: index.html :<script src="https://ajax.googleapis.com/ajax/libs/angularjs/1.7.5/angular-route.min.js"></script>
